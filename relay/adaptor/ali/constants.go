...
var ModelRatios = map[string]adaptor.ModelPrice{
	...
	"wanx2.1-t2i-turbo":             {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"wanx2.1-t2i-plus":              {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"wanx2.0-t2i-turbo":             {Ratio: 0.01 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"wanx2.1-imageedit":             {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"wanx-sketch-to-image-lite":     {Ratio: 0.01 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"wanx-style-repaint-v1":         {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"wanx-background-generation-v2": {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"aitryon":                       {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"aitryon-parsing-v1":            {Ratio: 0.01 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"aitryon-refiner":               {Ratio: 0.05 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"facechain-generation":          {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"wordart-texture":               {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
	"wordart-semantic":              {Ratio: 0.04 * ratio.ImageRmbPerPic, CompletionRatio: 1.0},
}
